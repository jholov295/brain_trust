...
function run()
	...
	if _TEAMCITY then
		...
		ans = prompt("Do you want to update the firmware?")

		if yes(ans) then
			url = prompt('Enter location of the desired hex file')
	...
	elseif _LEXECUTOR then
		...
		basic= yes(prompt("Do you want to run the basic tests?"))
		advan = yes(prompt("Do you want to run the advanced tests?"))
