...
-- <br/>
-- <br/>
-- There are two significant symbols in templates: # and $()<br/>
-- A line that starts with # is interpreted as Lua.<br/>
-- Other lines are written as plain text, with any $() symbols replaced by their contents.<br/>
-- <pre class="example">
-- Number = $( 2 + 3 )<br/>
-- <br/>
-- Output:<br/>
